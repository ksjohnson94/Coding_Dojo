...
RSpec.describe SolarSystem do
	describe 'initialization' do
     ...
     if not its default name should be 'Solar System'" do
		...
		it "should contain a list of all planets" do
			...
			expect(@solarSystem.planets).to match_array(["Mercury", "Venus", "Earth",
	...
	describe 'behavior' do
		...
		it "should have a method called Super Nova that destroys
     all of the planets in it" do
